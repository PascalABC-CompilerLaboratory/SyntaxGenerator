...
namespace SyntaxVisitors
{
    ...
    public class ProcessYieldCapturedVarsVisitor : BaseChangeVisitor 
    {
        ...
        public override void visit(procedure_definition pd)
        {
            ...
            foreach (string identName in dld.LocalDeletedDefsNames) // параметры остались. Их тоже надо исключать - они и так будут обработаны
                mids.vars.Remove(new ident(identName));
